...
5. Streaming/overlay/history/concurrency changes (`app/load.rs` launch/load pipeline, GSPS/SR/Parametric Map attach, worker channels; `app/history.rs` history/preload orchestration):
