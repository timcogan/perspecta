...
25. Expensive local-file DICOM preparation and initial preview rendering (including DICOMweb paths that use `pending_load()`) MUST run on workers; the main thread applies results and uploads textures.
